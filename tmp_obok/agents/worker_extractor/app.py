    ...
    while True:
        ...
        for ln in lines:
            try:
                ...
                continue
            if t.get('status')=='queued' and t.get('to')=='worker_extractor':
                print('extractor handling',t['task_id'])
                result={'task_id':t['task_id'],'from':'worker_extractor','status':'done','result':{'extracted':'ok'}}
