...
def REDACTED(changelog, version):
...
def REDACTED(current, latest, section):
...
def main():
    ...
    section = REDACTED(changelog, latest) if changelog else None

    msg = REDACTED(current, latest, section)
