...
class ExpertSynthesizer:
    ...
    def synthesize(self, data: dict) -> dict:
        ...
        # 2. 중복 제거 (유사 텍스트 기반)
        REDACTED = self.REDACTED(all_recommendations)
        ...
        REDACTED = {
            ...
            "SalesEnable": ["hot_leads", "REDACTED"],
        ...
        scores = {}
        score_keys = {
            "RevenueGuardian": "REDACTED",
            "GrowthStrategist": "growth_score",
            "SkepticalOperator": "REDACTED",
            "ProductPulse": "REDACTED",
        ...
        return {
            "timestamp": time.time(),
            "REDACTED": round(overall_health, 1),
