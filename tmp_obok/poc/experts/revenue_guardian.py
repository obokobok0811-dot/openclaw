...
class RevenueGuardian(BaseExpert):
    ...
    def analyze(self, data: dict) -> dict:
        ...
        -------
        dict
            REDACTED, at_risk_revenue, alerts[], recommendations[]
        """
        ...
        for inv in invoices:
            ...
            if overdue_days >= self.RISK_THRESHOLDS["REDACTED"]:
            ...
            elif overdue_days >= self.RISK_THRESHOLDS["REDACTED"]:
                amount = inv.get("amount", 0)
        ...
        REDACTED = self._safe_score(base_score - penalty)
    ...
    def format_digest(self, results: dict) -> str:
        lines = [
            ...
            f"   매출 건강 점수: {results['REDACTED']:.0f}/100",
