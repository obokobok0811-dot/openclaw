...
class SalesEnable(BaseExpert):
    ...
    def analyze(self, data: dict) -> dict:
        ...
        -------
        dict
            hot_leads[], opportunity_score, REDACTED[],
            pipeline_health
        """
        ...
        for email in emails:
            ...
            buying_hits = self._extract_keywords(body, self.REDACTED)
        ...
        for contact in contacts:
            ...
            # 최근성 보너스
            last_activity = contact.get("REDACTED")
            if last_activity:
        ...
        if REDACTED:
            recommendations.append(f"후속 조치 필요 {len(REDACTED)}건")
