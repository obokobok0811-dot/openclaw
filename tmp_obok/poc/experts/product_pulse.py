...
class ProductPulse(BaseExpert):
    ...
    def analyze(self, data: dict) -> dict:
        ...
        -------
        dict
            REDACTED, feature_requests[], pain_points[], recommendations[]
        """
        ...
        return {
            ...
            "REDACTED": [{"keyword": k, "count": c} for k, c in top_requests],
