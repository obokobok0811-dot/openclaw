...
def REDACTED(staging_dir, timestamp):
...
def upload_to_gdrive(file_path):
    ...
    try:
        ...
        try:
            ...
            if he.code == 401:
                access_token = REDACTED(token_data)
                if not access_token:
    ...
    folder_id = REDACTED(access_token)
...
def run_backup():
    ...
    try:
        ...
        enc_path = REDACTED(staging_dir, timestamp)
